...
if __name__ == "__main__":
    ...
    for i in range(100):
        label_data[i, 0] = 1 + input_data[i, 0] * input_data[i, 0] + input_data[i, 1] * input_data[i, 2] # y1 = x_1^2 + x_2*x_3
        label_data[i, 1] = input_data[i, 0] * input_data[i, 1] - input_data[i, 2] * 3 # y_2 = x_1*x_2 - 3*x_3
